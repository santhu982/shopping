...
import shopping.reader.mycomponent.MyStreamReaderImpl
import shopping.transformer.mycomponent.MyStreamTransformerImpl
import shopping.writer.mycomponent.MyStreamWriterImpl
